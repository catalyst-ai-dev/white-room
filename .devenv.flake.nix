{
  ...
  devenv_root = "/workspace/repo";
  project_input_ref = "path:/workspace/repo";
  devenv_dotfile = "/workspace/repo/.devenv";
  devenv_dotfile_path = ./.devenv;
  devenv_tmpdir = "/tmp";
  devenv_runtime = "/tmp/devenv-090e213";
  devenv_istesting = false;
  devenv_direnvrc_latest_version = 1;
  container_name = null;
  active_profiles = [
  ];
  hostname = "7a7e20fc15de";
  username = "workspace";
